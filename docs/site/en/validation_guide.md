...
This guide focuses on the practical setup and usage patterns for the recent `validator` / `coerce` support. For the full parameter reference, see the [NanaSQLite API Reference](./api_sync.md).
